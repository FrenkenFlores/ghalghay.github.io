...
*/
    ...
    },
    {
        ...
        allowSorting: true,
        headerFilter: false,
        cssClass: "img-style", //Задает класс CSS, применяемый к ячейкам:
                                     //.dx-data-row .cell-highlighted {
        allowFiltering: false,
        cellTemplate: function (container, options) {
          container.append('' +
          //'<a href="javascript:openImage(\'' + options.value + '\',\'::\',3000,3000,\'\')" Xtarget="_blank">' +  //
          '<a href="' + options.value + '" target="_blank">' +
            '<div class="img-container">' +
              '<img src="' + options.value + '" alt="" class="img-container_item">' +
            '</div>' +
          '</a>'
          );
        }
